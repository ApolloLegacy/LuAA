...
devoptab_t EFSdevoptab = {
    ...
    &EFS_DirOpen,               // DIR_ITER* (*opendir_r)(struct _reent *r, DIR_ITER *dirState, const char *path);
    &EFS_DirReset,              // int (*dirreset_r)(struct _reent *r, DIR_ITER *dirState);
    &EFS_DirNext,               // int (*readdir_r)(struct _reent *r, DIR_ITER *dirState, char *filename, struct stat *filestat);
    &EFS_DirClose               // int (*closedir_r)(struct _reent *r, DIR_ITER *dirState);    
};
